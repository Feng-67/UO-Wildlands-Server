...
m_Stream.Write( (int) renderMode );
	...
	public sealed class SkillUpdate : Packet
	{
			...
			: base(0x3A)
		{
			...
			for (int i = 0; i < skills.Length; ++i)
			{
                ...
                m_Stream.Write((ushort)(SkillInfo.FreeSkills.Contains(s.SkillName) ? 0 : s.BaseFixedPoint)); // ← change this line
	...
	public sealed class SkillChange : Packet
	{
			...
			: base(0x3A)
		{
			...
			m_Stream.Write((ushort)uv);
            m_Stream.Write((ushort)(SkillInfo.FreeSkills.Contains(skill.SkillName) ? 0 : skill.BaseFixedPoint)); // ← change this line
