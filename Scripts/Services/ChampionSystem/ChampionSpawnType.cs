...
namespace Server.Engines.CannedEvil
{
    ...
    public class ChampionSpawnInfo
    {
        ...
        private static readonly ChampionSpawnInfo[] m_Table = new ChampionSpawnInfo[]
        {
            ...
            new ChampionSpawnInfo( "Orc", typeof( Garthok ), new string[]{ "Bane", "Killer", "Vanquisher" } , new Type[][]
            {
                new Type[]{ typeof( Orc ), typeof( OrcCaptain ) },                                                      // Level 1
                new Type[]{ typeof( OrcBomber ), typeof( OrcScout ) },                                                  // Level 2
                new Type[]{ typeof( OrcishMage ), typeof( OrcishLord ) },                                               // Level 3
                new Type[]{ typeof( OrcBrute ), typeof( OrcHound ) }                                                    // Level 4
            } ),

            new ChampionSpawnInfo( "Beholder", typeof( Xorvintaal ), new string[]{ "Watcher", "Observer", "Overlord" } , new Type[][]
            {
                new Type[]{ typeof( GazerLarva ) , typeof( Gargoyle ) },                                                // Level 1
                new Type[]{ typeof( Gazer ) , typeof( StoneGargoyle ) },                                                // Level 2
                new Type[]{ typeof( ElderGazer ) ,typeof( Daemon ) },                                                   // Level 3
                new Type[]{ typeof( ElderGazer ) , typeof( Balron ) }                                                   // Level 4
    } ),
        };
