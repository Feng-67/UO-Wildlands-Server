...
namespace Server.Engines.CleanUpBritannia
{
    public static class CleanUpBritanniaRewards
    {
        ...
        public static void Initialize()
        {
            ...
            Rewards.Add(new CollectionItem(typeof(MagicalResidueBundle), 0x2DB1, 1031697, 0, 1000));
            Rewards.Add(new CollectionItem(typeof(EnchantedEssenceBundle), 0x2DB2, 1031698, 0, 1000));
            Rewards.Add(new CollectionItem(typeof(RelicFragmentBundle), 0x2DB3, 1031699, 0, 1000));

Rewards.Add(new CollectionItem(typeof(AlacrityScrollPicker), 0x9981, 1154324, 2601, 1000));
        ...
        //    Rewards.Add(new CollectionItem(typeof(ArachnidDoom), 0x0E9C, 1154738, 1944, 20000));
            ...
            if (Core.SA)
            {
                ...
                */
                ...
                Rewards.Add(new CollectionItem(typeof(DaviesLockerAddonDeed), 0x14F0, 1153535, 0, 500000.0));
                Rewards.Add(new CollectionItem(typeof(VollemHeldInCrystal), 0x1f19, 1113629, 1154, 500000));
            }

        }
    }
// ... (The rest of your file is above this) ...

     

    // ---------------------------------------------------------
    //  PASTE THESE CLASSES HERE (Between the two final brackets)
    // ---------------------------------------------------------

    public class MagicalResidueBundle : MagicalResidue 
    { 
        [Constructable] 
        public MagicalResidueBundle() : base(100) { } 
        public MagicalResidueBundle(Serial serial) : base(serial) { } 
        public override void Serialize(GenericWriter writer) { base.Serialize(writer); } 
        public override void Deserialize(GenericReader reader) { base.Deserialize(reader); } 
    }

    public class EnchantedEssenceBundle : EnchantedEssence 
    { 
        [Constructable] 
        public EnchantedEssenceBundle() : base(100) { } 
        public EnchantedEssenceBundle(Serial serial) : base(serial) { } 
        public override void Serialize(GenericWriter writer) { base.Serialize(writer); } 
        public override void Deserialize(GenericReader reader) { base.Deserialize(reader); } 
    }

    public class RelicFragmentBundle : RelicFragment 
    { 
        [Constructable] 
        public RelicFragmentBundle() : base(100) { } 
        public RelicFragmentBundle(Serial serial) : base(serial) { } 
        public override void Serialize(GenericWriter writer) { base.Serialize(writer); } 
        public override void Deserialize(GenericReader reader) { base.Deserialize(reader); } 
    }

} // Closes the 'Server.Engines.CleanUpBritannia' namespace
