...
namespace Server.Mobiles
{
    ...
    public class DiseasedBloodElemental : BloodElemental
    {
        ...
        public override double AutoDispelChance { get { return 0.05; } }
        public override int TreasureMapLevel { get { return 2; } }
        public override double TreasureMapChance { get { return 0.0; } }
        ...
        public override void OnDeath(Container c)
        {
            ...
            // This adds two (Cache) maps with 100% certainty
            c.DropItem(new TreasureMap(2, Map.Felucca)); // Or Map.Internal for random map
            c.DropItem(new TreasureMap(2, Map.Felucca));

            // Existing Shame Crystal logic
            if (0.33 > Utility.RandomDouble() && Region.Find(c.Location, c.Map).IsPartOf("Shame"))
                c.DropItem(new ShameCrystal(5));
        }
