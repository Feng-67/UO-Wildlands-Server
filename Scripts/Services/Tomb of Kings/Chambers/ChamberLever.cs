...
namespace Server.Engines.TombOfKings
{
    public class ChamberLever : Item
    {
        ...
        {
            // Levers disabled: no longer placed, since chambers no longer exist.
            return;
        }
        ...
        public override void Deserialize(GenericReader reader)
        {
            ...
            // One-time cleanup: levers are disabled, remove any that persisted
            // from before this change instead of re-adding to the static list.
            Delete();
        }
    }
}
