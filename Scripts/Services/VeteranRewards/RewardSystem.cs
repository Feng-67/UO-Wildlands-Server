...
public class RewardSystem
    {
        ...
        public static int SkillCap = 7200; 
        public static int SkillCapBonus = 0; 
        public static int SkillCapBonusLevels = 1; 

        // Change this line to just be 0.0f
        // This removes the division (the "/" symbol) entirely so it CANNOT crash.
        public static float SkillCapBonusIncrement = 0.0f;
        ...
        private static void EventSink_Login(LoginEventArgs e)
        {
            ...
            // This forces the cap to exactly what is in PlayerCaps.cfg (7200)
            // It ignores expansion bonuses and veteran reward bonuses.
