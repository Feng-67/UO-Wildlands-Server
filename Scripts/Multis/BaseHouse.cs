...
namespace Server.Multis
{
    ...
    {
        public static int AccountHouseLimit { get; } = Config.Get("Housing.AccountHouseLimit", 3);
        ...
        public virtual TimeSpan DecayPeriod { get { return TimeSpan.FromDays(365.0); } }
        ...
        public virtual DecayType DecayType
        {
            get
            {
                ...
                // Modified: All houses return AutoRefresh regardless of being 'newest'
