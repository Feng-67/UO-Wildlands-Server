...
//			PackItem(new Candle());
		...
		private static void EventSink_CharacterCreated(CharacterCreatedEventArgs args)
		{
			...
			// 2-second delay to ensure they are fully logged in before seeing the message
			Timer.DelayCall(TimeSpan.FromSeconds(2.0), () =>
			{
				if (newChar != null && !newChar.Deleted)
				{
					newChar.SendMessage(0x482, "Welcome to UO Wildlands! The frontier awaits!");
					newChar.PlaySound(0x5B5);
				}
			});
		}
