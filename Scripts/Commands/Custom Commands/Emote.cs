 ...
 * Derived from ServUO Core and Community scripts (Original Author ExX)
...
namespace Server.Scripts.Commands
{
	...
	{ 
		...
		{ 
			...
			Dragable = true; 
			AddPage( 0 );
			AddBackground( 0, 65, 150, 360, 5054);
			AddAlphaRegion( 10, 70, 130, 350 );
			AddImageTiled( 10, 70, 130, 20, 9354);
			AddLabel( 42, 70, 200, "Emote List");
			...
			switch ( page ) 
			{
				case EmotePage.P1:
				{
					AddButtonLabeled( 15, 95, GetButtonID( 1, 1 ), "Ah");
					AddButtonLabeled( 15, 120, GetButtonID( 1, 2 ), "Ah-ha");
					AddButtonLabeled( 15, 145, GetButtonID( 1, 3 ), "Applaud");
					AddButtonLabeled( 15, 170, GetButtonID( 1, 4 ), "Blows Nose");
					AddButtonLabeled( 15, 195, GetButtonID( 1, 5 ), "Bows");
					AddButtonLabeled( 15, 220, GetButtonID( 1, 6 ), "BS Cough");
					AddButtonLabeled( 15, 245, GetButtonID( 1, 7 ), "Burp");
					AddButtonLabeled( 15, 270, GetButtonID( 1, 8 ), "Clear Throat");
					AddButtonLabeled( 15, 295, GetButtonID( 1, 9 ), "Cough");
					AddButtonLabeled( 15, 320, GetButtonID( 1, 10 ), "Cry");
					AddButtonLabeled( 15, 345, GetButtonID( 1, 11 ), "Faints");
					AddButtonLabeled( 15, 370, GetButtonID( 1, 12 ), "Fart");
					AddButton( 90, 380, 4502, 0504, GetButtonID( 0,2 ), GumpButtonType.Reply, 0 );
					break; 
				}
				case EmotePage.P2:
				{ 
					AddButtonLabeled( 15, 95, GetButtonID( 1, 13 ), "Gasp");
					AddButtonLabeled( 15, 120, GetButtonID( 1, 14 ), "Giggle");
					AddButtonLabeled( 15, 145, GetButtonID( 1, 15 ), "Groan");
					AddButtonLabeled( 15, 170, GetButtonID( 1, 16 ), "Growl");
					AddButtonLabeled( 15, 195, GetButtonID( 1, 17 ), "Hey");
					AddButtonLabeled( 15, 220, GetButtonID( 1, 18 ), "Hiccup");
					AddButtonLabeled( 15, 245, GetButtonID( 1, 19 ), "Huh");
					AddButtonLabeled( 15, 270, GetButtonID( 1, 20 ), "Kiss");
					AddButtonLabeled( 15, 295, GetButtonID( 1, 21 ), "Laughs");
					AddButtonLabeled( 15, 320, GetButtonID( 1, 22 ), "No");
					AddButtonLabeled( 15, 345, GetButtonID( 1, 23 ), "Oh");
					AddButtonLabeled( 15, 370, GetButtonID( 1, 24 ), "Oooh");
					AddButton( 10, 380, 4506, 4508, GetButtonID( 0,1 ), GumpButtonType.Reply, 0 );
					AddButton( 90, 380, 4502, 0504, GetButtonID( 0,3 ), GumpButtonType.Reply, 0 );
					break; 
				} 
				case EmotePage.P3:
				{
					AddButtonLabeled( 15, 95, GetButtonID( 1, 25 ), "Oops");
					AddButtonLabeled( 15, 120, GetButtonID( 1, 26 ), "Puke");
					AddButtonLabeled( 15, 145, GetButtonID( 1, 27 ), "Punch");
					AddButtonLabeled( 15, 170, GetButtonID( 1, 28 ), "Scream");
					AddButtonLabeled( 15, 195, GetButtonID( 1, 29 ), "Shush");
					AddButtonLabeled( 15, 220, GetButtonID( 1, 30 ), "Sigh");
					AddButtonLabeled( 15, 245, GetButtonID( 1, 31 ), "Slap");
					AddButtonLabeled( 15, 270, GetButtonID( 1, 32 ), "Sneeze");
					AddButtonLabeled( 15, 295, GetButtonID( 1, 33 ), "Sniff");
					AddButtonLabeled( 15, 320, GetButtonID( 1, 34 ), "Snore");
					AddButtonLabeled( 15, 345, GetButtonID( 1, 35 ), "Spit");
					AddButtonLabeled( 15, 370, GetButtonID( 1, 36 ), "Sticks Tongue");
					AddButton( 10, 380, 4506, 4508, GetButtonID( 0,2 ), GumpButtonType.Reply, 0 );
					AddButton( 90, 380, 4502, 0504, GetButtonID( 0,4 ), GumpButtonType.Reply, 0 );
					break; 
				} 
				case EmotePage.P4:
				{
					AddButtonLabeled( 15, 95, GetButtonID( 1, 37 ), "Taps Foot");
					AddButtonLabeled( 15, 120, GetButtonID( 1, 38 ), "Whistle");
					AddButtonLabeled( 15, 145, GetButtonID( 1, 39 ), "Woohoo");
					AddButtonLabeled( 15, 170, GetButtonID( 1, 40 ), "Yawn");
					AddButtonLabeled( 15, 195, GetButtonID( 1, 41 ), "Yea");
					AddButtonLabeled( 15, 220, GetButtonID( 1, 42 ), "Yell");
