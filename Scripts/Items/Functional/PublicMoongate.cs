...
namespace Server.Items
{
	...
	public class PMList
	{
		public static readonly PMList Trammel = new PMList(
			...
			new[]
			{
				new PMEntry(new Point3D(3486, 2572, 40), 1078321), // New Haven Bank
				...
				new PMEntry(new Point3D(2925, 3546, 10), 1072238), // Serpent's Hold
				new PMEntry(new Point3D(3768, 1296, 0), 1016053), // Bank of Nujelm
