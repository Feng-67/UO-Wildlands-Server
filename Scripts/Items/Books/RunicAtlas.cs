...
// PASTE THE CODE HERE
    ...
    {
        public static void Swap<T>(this System.Collections.Generic.List<T> list, int indexA, int indexB)
        {
            if (list == null || indexA < 0 || indexA >= list.Count || indexB < 0 || indexB >= list.Count)
                return;
