...
namespace Server.Gumps
{
    public abstract class BaseRewardGump : Gump
    {
            ...
            : base(50, 50)
        {
            ...
            AddImage(0, 0, 0x1F40);
            AddImageTiled(20, 37, 300, 616, 0x1F42);
            AddImage(20, 633, 0x1F43);
            AddImage(35, 8, 0x39);
        ...
        public void DisplayRewardPage()
        {
            ...
            while (offset + next < 628 && Index < Collection.Count)
            {
            ...
            if (Page > 1)
            {
                AddButton(150, 643, 0x15E3, 0x15E7, 0, GumpButtonType.Page, Page - 1);
                AddHtmlLocalized(170, 643, 60, 20, 1074880, 0x1, false, false); // Previous			
            }
            ...
            if (Index < Collection.Count)
            {
                AddButton(300, 643, 0x15E1, 0x15E5, 0, GumpButtonType.Page, Page);
                AddHtmlLocalized(240, 643, 60, 20, 1072854, 0x1, false, false); // <div align=right>Next</div>
            }
        }
