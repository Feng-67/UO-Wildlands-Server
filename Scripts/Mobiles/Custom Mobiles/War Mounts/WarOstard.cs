...
{   
    [CorpseName("a war ostard corpse")]
    public class WarOstard : BaseMount, IBardedMount
    {
        ...
        public WarOstard(Serial serial)
            : base(serial)
        {
        }
        ...
        public bool HasBarding
        {
            ...
            set
            {
                ...
                // No dedicated barded-ostard body art exists, so barding is
