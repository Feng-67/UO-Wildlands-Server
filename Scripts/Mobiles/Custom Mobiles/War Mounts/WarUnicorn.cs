...
namespace Server.Mobiles
{
    ...
    public class WarUnicorn : BaseMount, IBardedMount
    {
        ...
        [Constructable]
        public WarUnicorn(string name)
            : base(name, 0x7A, 0x3EB4, AIType.AI_Melee, FightMode.Aggressor, 10, 1, 0.2, 0.4)
        {
            BaseSoundID = 0x4BC;
        ...
        public WarUnicorn(Serial serial)
            : base(serial)
        {
        }
        ...
        public bool HasBarding
        {
            ...
            set
            {
                ...
                // No dedicated barded-unicorn body art exists, so barding is
                // expressed purely as a hue change (unlike SwampDragon, which
                // also swaps BodyValue/ItemID).
